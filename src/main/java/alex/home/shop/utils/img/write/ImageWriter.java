...
public abstract class ImageWriter {
    ...
    protected volatile int defImgSize = 1000;
    ...
    protected volatile String defExctension = ".jepg";
    
    public abstract String writeImageAndGetUrl(byte[] img, Integer convertSize, String extension, SizeConverter converter, Boolean isResize);
